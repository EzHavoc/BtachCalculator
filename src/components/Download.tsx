      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-16">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 hover:shadow-md transition-shadow">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-2">v2.5.3 (64-bit) • 35MB</p>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 hover:shadow-md transition-shadow">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-2">v2.5.3 • 42MB</p>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 hover:shadow-md transition-shadow">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-2">v2.5.3 • 33MB</p>
          </div>
        </div>
